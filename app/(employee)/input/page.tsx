...
export default function EmployeeInputPage() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center animate-fadeIn py-8 px-4 w-full">
      {/* Title Header Card */}
      <div className="w-full max-w-3xl bg-white border border-[#e9ecef] rounded-[24px] p-6 sm:p-8 shadow-[0_8px_30px_rgba(0,0,0,0.015)] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5 relative z-10 mb-6">
