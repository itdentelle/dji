...
export default function QCDetailModal({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl flex flex-col my-auto animate-scaleIn overflow-hidden max-h-[90vh]"
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium mt-0.5">
                Desain: {header.design_id || "-"} / Potongan:{" "}
                {header.potongan_ke || "-"}
              </p>
            </div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 bg-slate-50/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              <h4 className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-3 flex items-center gap-2">
                <Package className="w-4 h-4" /> Rekapitulasi Hasil Batch (PCS
                Ini)
              </h4>
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-3">
                    ...
                    <div className="text-xl font-black text-emerald-600">
                      {group.inspeksi_ceklis} {itemLabel}
                    </div>
                  </div>
                  <div className="bg-slate-50 border border-slate-100 rounded-xl p-3">
                    <div className="text-[10px] text-slate-400 font-bold mb-1 uppercase tracking-wider">
                    ...
                    <div className="text-xl font-black text-rose-600">
                      {group.inspeksi_silang} {itemLabel}
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    {[...(group.items || [])]
                      .sort((a: any, b: any) => {
                        ...
                        if (aPanel === "METERAN" && bPanel === "METERAN") {
                          ...
                          return (
                            (isNaN(aMeter) ? 0 : aMeter) -
                            (isNaN(bMeter) ? 0 : bMeter)
                          );
                        }
                        ...
                        return String(aPanel || "").localeCompare(
                          String(bPanel || ""),
                          undefined,
                          {
                            numeric: true,
                      ...
                      .map((item: any, idx: number) => {
                        ...
                        if (detail.final_inspection_id === 1) {
                          ...
                          detail.final_inspection_id === 2 ||
                          detail.final_inspection_id === 3
                        ) {
                          itemText = "Cacat";
                          Icon = XCircle;
